...
public class etape12_shared extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_etape12_shared);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent2 = new Intent(etape12_shared.this, etape14_shared.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent2 = new Intent(etape12_shared.this, etape10_shared.class);
                intent2.putExtra("RoE",RoE);
                intent2.putExtra("code",code);
                startActivity(intent2);
            }
        ...
        myD=findViewById(R.id.C1);
        yourD=findViewById(R.id.C2);
        onshow();
    }
    public void onshow(){
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < juser.length(); i++) {
                        ...
                        String T1 = obj.getString("circonstancesE");
                        myD.setText(T1);

                        String T2 = obj.getString("circonstancesR");
                        yourD.setText(T2);
                    ...
                    e.printStackTrace();
                    //Toast.makeText(etape12_shared.this,e.toString(),Toast.LENGTH_LONG).show();
                }
            }
        },new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(etape12_shared.this,error.toString(),Toast.LENGTH_LONG).show();
            }

        });
        Volley.newRequestQueue(etape12_shared.this).add(req);
    }
}